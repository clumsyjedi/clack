...
var pred__15475 = cljs.core._EQ_;
var expr__15476 = input_type;
if(cljs.core.truth_(pred__15475.call(null,cljs.core.cst$kw$json,expr__15476))){
return clack.parser.json.parser.call(null);
} else {
if(cljs.core.truth_(pred__15475.call(null,cljs.core.cst$kw$str,expr__15476))){
return clack.parser.string.parser.call(null);
} else {
if(cljs.core.truth_(pred__15475.call(null,cljs.core.cst$kw$tjs,expr__15476))){
return clack.parser.transit.parser.call(null);
} else {
if(cljs.core.truth_(pred__15475.call(null,cljs.core.cst$kw$yaml,expr__15476))){
