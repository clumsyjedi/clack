...
var pred__14875 = cljs.core._EQ_;
var expr__14876 = input_type;
if(cljs.core.truth_(pred__14875.call(null,cljs.core.cst$kw$json,expr__14876))){
return clack.parser.json.parser.call(null);
} else {
if(cljs.core.truth_(pred__14875.call(null,cljs.core.cst$kw$str,expr__14876))){
return clack.parser.string.parser.call(null);
} else {
if(cljs.core.truth_(pred__14875.call(null,cljs.core.cst$kw$tjs,expr__14876))){
