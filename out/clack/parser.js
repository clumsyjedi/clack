...
var pred__14871 = cljs.core._EQ_;
var expr__14872 = input_type;
if(cljs.core.truth_(pred__14871.call(null,cljs.core.cst$kw$json,expr__14872))){
return clack.parser.json.parser.call(null);
} else {
if(cljs.core.truth_(pred__14871.call(null,cljs.core.cst$kw$str,expr__14872))){
return clack.parser.string.parser.call(null);
} else {
if(cljs.core.truth_(pred__14871.call(null,cljs.core.cst$kw$tjs,expr__14872))){
